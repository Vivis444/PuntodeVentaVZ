...
from core.model1.forms import CategoryForm
from core.model1.mixins import ValidatePermissionRequiredMixin
from core.model1.models import Category
...
class CategoryListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('model1:category_create')
        context['list_url'] = reverse_lazy('model1:category_list')
...
class CategoryCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('model1:category_list')
