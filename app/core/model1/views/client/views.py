...
from core.model1.forms import ClientForm
from core.model1.mixins import ValidatePermissionRequiredMixin
from core.model1.models import Client
...
class ClientListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('model1:client_create')
        context['list_url'] = reverse_lazy('model1:client_list')
...
class ClientCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('model1:client_list')
