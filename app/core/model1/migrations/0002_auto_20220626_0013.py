    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='model1.category', verbose_name='Categoría')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cli', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='model1.client')),
            ],
            options={
                'verbose_name': 'Venta',
        ...
        migrations.AddField(
            model_name='detsale',
            name='prod',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='model1.product'),
        ),
        migrations.AddField(
            model_name='detsale',
            name='sale',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='model1.sale'),
        ),
    ]
